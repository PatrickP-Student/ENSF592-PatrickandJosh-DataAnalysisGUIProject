...
data from any data sets, ordering columns, etc), convert the data structure to a dict() type, and 
write the dictionaries to the database specified
'''
...
# collection1.insert_many(records1) ## THIS WILL UPLOAD THE DICTS TO THE DB
...
records1a = df1a.to_dict(orient = 'dict')
...
records2a = df2a.to_dict(orient = 'dict')
...
records3a = df3a.to_dict(orient = 'dict')

# collection1a.insert_many(records1a) ## THIS WILL UPLOAD THE DICTS TO THE DB
# collection2a.insert_many(records2a)
# collection3a.insert_many(records3a)
